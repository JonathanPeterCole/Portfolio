        ...
        <div className='controls'>
          <div className='arrow left' onClick={this.previousSlide}>
            <svg className='icon' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12'>
              ...
              <path d='M9,9.88,5.12,6,9,2.12A1,1,0,0,0,7.59.71L3,5.3A1,1,0,0,0,3,6.71l4.59,4.58A1,1,0,1,0,9,9.88Z' transform='translate(0)' fill='#ffffff'/>
            </svg>
          </div>
          <div className='arrow right' onClick={this.nextSlide}>
            <svg className='icon' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12'>
              <rect width='12' height='12' fill='none'/>
              <path d='M3,11.29a1,1,0,0,0,1.41,0L9,6.71A1,1,0,0,0,9,5.3L4.41.71A1,1,0,0,0,3,2.12L6.88,6,3,9.88A1,1,0,0,0,3,11.29Z' transform='translate(0)' fill='#ffffff'/>
            </svg>
          </div>
        </div>
      </div>
